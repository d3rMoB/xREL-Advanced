...
$(document).ready(function() {
    ...
    $('#xrelAdvMenu input').change(function() {
        ...
        $('input.xrelSeCheckbox,input.xrelOptionCheckbox:not(checked)').each(function() {
            ...
            if ( id == 'expandedtrailers' || id == 'quickcover' || id == 'quickfilter' ) {
    ...
    function quickfilter() {
        if (
            ...
            window.location.pathname.match(/^\/movie\/.*/)
           ) {
    ...
    function darkmode(css) {
        ...
        GM_addStyle('#searchAutoComplete .content {border: none; filter: invert(80%); color: #000;}')
    }
});
