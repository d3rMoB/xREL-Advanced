...
// @icon64			https://github.com/d3rMoB/xREL-Advanced/raw/master/xrel.png
...
newEngine.baseUrl = "http://1load.sx";
newEngine.method = "get";
newEngine.methodName = "s";
...
// boerse.to
newEngine = {};
newEngine.id = "boerseto";
newEngine.title = "boerse.to";
newEngine.baseUrl = "https://boerse.to/search/";
newEngine.method = "post";
newEngine.methodName = "keywords";
newEngine.methodToken = "_xfToken";
newEngine.icon = "data:image/png;base64,";
newEngine.active = false;
searchEngines.push(newEngine);
...
newEngine.baseUrl = "http://www.crawli.net/all/";
newEngine.method = "post";
newEngine.methodName = "key";
...
newEngine.baseUrl = "https://ddl-warez.to";
newEngine.method = "get";
newEngine.methodName = "search";
...
newEngine.baseUrl = "http://gload.cc";
newEngine.method = "get";
newEngine.methodName = "s";
...
newEngine = {};
newEngine.id = "g4ume";
newEngine.title = "g4u.me";
newEngine.baseUrl = "http://www.g4u.me/search.html";
newEngine.method = "post";
newEngine.methodName = "searchItem";
newEngine.icon = "data:image/ico;base64,";
newEngine.active = false;
searchEngines.push(newEngine);
...
newEngine.baseUrl = "http://www.movie-blog.org/index.php";
newEngine.method = "get";
newEngine.methodName = "s";
...
newEngine.baseUrl = "https://scenedownloads.pw";
newEngine.method = "get";
newEngine.methodName = "search";
...
newEngine.baseUrl = "http://warez-world.org/search/";
newEngine.method = "get";
newEngine.methodName = "sq";
...
newEngine.baseUrl = "http://www.google.de/search";
newEngine.method = "get";
newEngine.methodName = "as_q";
...
newEngine = {};
newEngine.id = "3dlam";
newEngine.title = "3dl.am";
newEngine.baseUrl = "http://3dl.am";
newEngine.method = "get";
newEngine.methodName = "Suche";
...
newEngine.baseUrl = "http://ddl-search.biz/Alles/";
newEngine.method = "post";
newEngine.methodName = "allesSearchInput";
...
newEngine.method = "old";
newEngine.methodName = "";
...
newEngine = {};
newEngine.id = "searchengines";
newEngine.title = "Search Engines";
newEngine.active = true;
otherOptions.push(newEngine);

newEngine = {};
newEngine.id = "actorimages";
newEngine.title = "Actor Images";
newEngine.active = false;
otherOptions.push(newEngine);

newEngine = {};
newEngine.id = "extendedtrailers";
newEngine.title = "Extended Trailers";
newEngine.active = false;
otherOptions.push(newEngine);

newEngine = {};
newEngine.id = "newtab";
newEngine.title = "New Tab";
newEngine.active = true;
otherOptions.push(newEngine);

newEngine = {};
newEngine.id = "copybutton";
newEngine.title = "Copy Button";
newEngine.active = false;
otherOptions.push(newEngine);
...
fillUpDefaultPersistConfigObj(otherOptions);
...
$(document).ready(function() {
    GM_addStyle(".getReleaseName, .xrelSeToggle {	cursor: pointer; } .release_options {	padding-top: 0px !important; } .release_options a img {	width:13px; } .release_options span img {	width:13px; getReleaseName} .nfo_title .getReleaseName { margin-left:5px; } .nfo_title .getReleaseName img { width:16px; vertical-align: sub; }");
    ...
    if (xrelConfig.searchengines) {
        GM_addStyle(".release_item {	height: 46px !important; } ");
	...
	function createIconWithLink(relName, sEngines) {
		...
		for (var i = 0; i < sEngines.length; i++) {
            ...
            links += '<span style="' + hidden + '" class="xrelSeToggle" data-id="' + engine.id + '" data-url="' + engine.baseUrl + '" data-method="' + engine.method + '" data-methodname="' + engine.methodName + '" data-rel="' + relNameMod + '"><img border="0" src=' + engine.icon + ' alt="' + engine.title + '" width="13" height="13" />&nbsp;</span>';
		}
    ...
    $('.xrelSeToggle').click(function() {
        post($(this).data('url'), { [$(this).data('methodname')] : $(this).data('rel')}, $(this).data('method'));
	});
    ...
    function initConfigPanel() {
        ...
        $('#xrelSeConfig').append( '<b>Product Name Based</b><br>' + buildEngineActivatorElements( productNameSearchEngines) + '<br>');
        $('#xrelSeConfig').append( '<b>Release Name Based</b><br>' + buildEngineActivatorElements( searchEngines) + '<br>');
        $('#xrelSeConfig').append( '<b>Additional Options</b><br>' + buildEngineActivatorElements( otherOptions) );
    ...
    function buildEngineActivatorElements(sEngines) {
        ...
        for (var i = 0; i < sEngines.length; i++) {
        	var engine = sEngines[i];
            text += '<input class="xrelSeCheckbox" id="' + engine.id + '" type="checkbox" name="' + engine.id + '" value="' + engine.id + '" /> ';
            if (engine.icon) {
                text += ' <img border="0" src=' + engine.icon + ' alt="' + engine.title + '" width="13" height="13" /> <a href="http://' + engine.title + '">' + engine.title + '<a /><br /> ';
            } else {
                text += engine.title + '<br /> ';
            }
        }
        return text;
    }
    ...
    if (xrelConfig.extendedtrailers) {
    ...
    if (xrelConfig.newtab) {
        $('a, area').click(function () {
            ...
            if(href.indexOf('derefer') != -1 || href.indexOf('http') == 0) {
