...
newEngine = {};
newEngine.id = "wrzbz";
newEngine.title = "wrz.bz";
newEngine.baseUrl = "https://wrz.bz/search/%s";
newEngine.icon = "data:image/x-icon;base64,";
newEngine.active = false;
searchEngines.push(newEngine);
